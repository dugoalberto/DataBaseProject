...
#define CONFIGURE_ARGS " '--disable-debug' '--prefix=/opt/homebrew/Cellar/libpq/15.3' '--with-gssapi' '--with-openssl' '--libdir=/opt/homebrew/opt/libpq/lib' '--includedir=/opt/homebrew/opt/libpq/include' 'CC=clang' 'CXX=clang++' 'PKG_CONFIG_PATH=/opt/homebrew/opt/openssl@1.1/lib/pkgconfig:/opt/homebrew/opt/krb5/lib/pkgconfig' 'PKG_CONFIG_LIBDIR=/usr/lib/pkgconfig:/opt/homebrew/Library/Homebrew/os/mac/pkgconfig/13'"
...
#define PG_VERSION_STR "PostgreSQL 15.3 on aarch64-apple-darwin22.4.0, compiled by Apple clang version 14.0.3 (clang-1403.0.22.14.1), 64-bit"
